...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-365fe8c9", module.exports)
  } else {
...
exports.default = {
	...
	props: ['name', 'date'],
	methods: {
		event_date: function event_date(date) {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"row well\">\n\t<dt style=\"text-align:center\">Venue Address</dt>\n\t<div class=\"col-xs-12\" style=\"text-align:center\">{{venue.address1}} {{venue.address2}}</div>\n\t<div class=\"col-xs-12\" style=\"text-align:center\">{{venue.city}}, {{venue.state}} {{venue.zip}}</div>\n\t<div class=\"col-xs-12\">&nbsp;</div>\n\t<div class=\"col-xs-12\" style=\"text-align:center\"><b>Capacity</b> {{venue.capacity}}</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-9e992eae", module.exports)
  } else {
...
exports.default = {
	...
	methods: {
		edit_link: function edit_link(date) {
			return moment(date).format('MMM Do YYYY');
		}
	}
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5a46804d", module.exports)
  } else {
...
var _venueTitle = require('./components/venue-title.vue');

var _venueTitle2 = _interopRequireDefault(_venueTitle);

var _venueAddress = require('./components/venue-address.vue');

var _venueAddress2 = _interopRequireDefault(_venueAddress);

var _bandList = require('./components/band-list.vue');
...
exports.default = {
	...
	computed: {
		shows: function shows() {
			return _store2.default.state.shows;
		}
	},
	components: {
