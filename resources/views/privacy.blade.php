...
@section('content')
<div class="well col-xs-12 col-md-6 col-md-offset-3" style="color:#000;">
	<h2>Privacy Policy</h2>
	Last updated: July 1, 2016
<br>
	<div class="col-xs-12">
		Eternally Nocturnal LLC operates <a href="https://eternallynocturnal.com">https://eternallynocturnal.com</a> (the
	...
	<div class="col-xs-12">
		...
		materials and other information in accordance with the CAN-SPAM act.
	</div>

	<div class="col-xs-12">
		<h4>Payments</h4>
		All payments made through the Site are maintained by Stripe Inc. At no time is any credit card or 
		other payment information stored on our servers.
	</div>
	...
	<div class="col-xs-12">
		<h4>Security</h4>
		The security of your Personal Information is important to us, but please consider that no method of
		transmission over the Internet, or method of electronic storage, is 100% secure. We implement SSL certificates
		and database encryption to maintain the integrity of our services. While we strive to
	...
	<div class="col-xs-12">
		...
		This Privacy Policy is effective as of July 1, 2016 and will remain in effect except with respect to any
